...
class TestOne(BaseCase):
    ...
    @pytest.mark.UI
    def test_login(self):
        self.login_page.click(self.login_page.locators.LOGIN_BUTTON_LOCATOR, timeout=BASE_TIMEOUT)
        self.login_page.login(email, password)
        assert self.base_page.find_on_page('How to get started?')
    ...
    def test_logout(self):
        ...
        assert self.base_page.find_on_page('Рекламируйте товары и услуги в соцсетях')
    ...
    def test_change_contact_info(self):
        ...
        new_user_name = user_name + self.base_page.generate_random_name(5)
        new_user_email = self.base_page.generate_random_name(5) + user_email
    ...
    def test_menu_items(self, menu_item, opened_page_text):
        ...
        assert self.base_page.find_on_page(opened_page_text)
